...
### Message to Jason (help from gpt-4)
Subject: Seeking Introduction to Pacific Biosciences Hiring Team

> Hello Jason,

> I hope all is well with you! How have you been since transitioning from academia to the industry? Like you, I am looking to make a similar shift after leaving the Eichler Lab.

> I noticed that Pacific Biosciences is currently hiring bioinformaticians, and I am very interested in pursuing an opportunity with your company. I was wondering if you might have any contacts within the hiring team and if you would feel comfortable making an introduction on my behalf. If you believe that you're familiar enough with my work history and skill set, I would be incredibly grateful for your assistance in connecting me with the hiring team.

> Thank you in advance for any help you can provide, and I look forward to catching up with you soon!

### Message to Zev 
Subject: Eichler lab alummnus seeking to connect

Hello Zev,

I hope you're doing well. My name is Ruiyang. I worked at Evan's lab for a few years with Arvis and Pete. About a year ago Arvis sent you an email to connect us, and I wanted to reach out and follow up. At Eichler lab I independently run phased assemblies by combining PacBio data with 10x and strand-seq. I wrote and maintained many of our targeted assembly pipelines at the time and did some work at resolving and visualizing large VNTR assemblies. I also did some work predicting new gene models and amino-acid sequences using HiFi and IsoSeq data (now in Mao et al Nature 2021). I'm currently in a computer engineering MS program and about to graduate this year. I am looking for Bioinformatics and dev positions. I noticed that Pacific Biosciences is currently hiring bioinformaticians, and I am very interested in pursuing an opportunity with PacBio. If you could spear some time to connect and maybe chat, I would be incredibly grateful. 
...
### Message to Bloomberg team (hlep from gpt-4) (not that good :( )
